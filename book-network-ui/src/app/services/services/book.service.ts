...
export class BookService extends BaseService {
  ...
  static readonly ReturnBorrowBookPath = '/books/borrow/return/{book_id}';
  ...
  static readonly ApprovedReturnBorrowBookPath = '/books/borrow/return/approved/{book_id}';
  ...
  static readonly UpdateShareableStatusPath = '/books/shareable/{book_id}';
